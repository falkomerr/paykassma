...
export const AnimatedButton = ({
  ...
  return (
    <button
      className={cn(
        'group/button relative z-[999] inline-flex cursor-pointer items-center justify-center overflow-hidden rounded-xl text-base font-medium text-white backdrop-blur-sm focus:outline-none',
        size === 'big'
