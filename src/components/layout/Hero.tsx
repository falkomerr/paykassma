      ...
      <div className="group absolute top-[85%]">
        ...
        <AnimatedButton
          ...
          <div className="relative flex h-[3.40104166667vw] w-[14.8541666667vw] items-center justify-center transition-all duration-500 group-hover/button:h-[3.1vw] group-hover/button:w-[14.1vw]">
            <div className="absolute inset-0 top-[33%] h-[1.2vw] w-full overflow-hidden">
              ...
              <div className="absolute w-full translate-y-full text-[1.15625vw] leading-[1] transition-transform duration-300 group-hover/button:translate-y-0">
                {t('buttons.submit')}
              </div>
            </div>
          </div>
